    ...
    if(0 == qsh_con_check)
    {
        ...
        while(NULL != (ptr2 = strsep(&path, " ")))
        {
            ...
            if(0 == i%2){
                ...
                //if(4 == cnt)
                //    printk("Q_sh : %s tail\n",__func__);
                //    qsh_path_path[cnt][strlen(ptr2)] = '\0';
        ...
        kfree(path);
         ...
         for(i=0;i<5;i++)
         {
             ...
             {
                 printk("Q_sh : %s qsh_path_path : %s\n",__func__,qsh_path_path[i]);
         ...
         if(0 == qsh_con_flag)  
         {
             ...
             {                  
                 ...
                 {              
                     ...
                     strncpy(qsh_path_con_path[i], tmp2, strlen(tmp2)+1);
...
static int ovl_fill_super(struct super_block *sb, void *data, int silent)
{
	...
	//HOON
	if(0 == strncmp("0",k8s_check,1)){
		//printk("Q_sh : %s main root(/) directory NULL\n",__func__);
		OVL_I(d_inode(root_dentry))->qsh_dentry = NULL;
		ofs->qsh_mnt = NULL;
	}else{
